...
module Assistants
  class Lawyer
    ...
    def process_norwegian_legal_query(input, _context)
    ...
    def process_international_legal_query(input, _context)
      specialization = detect_specialization(input)
    ...
    def conduct_legal_research(query, _specialization)
      results = []
    ...
    def generate_legal_analysis(_input, specialization, jurisdiction)
      <<~ANALYSIS
        **Legal Analysis:**
    ...
    def generate_contract_recommendations(_contract_text)
      [
    ...
    def check_legal_compliance(_contract_text, contract_type)
      compliance_items = []
