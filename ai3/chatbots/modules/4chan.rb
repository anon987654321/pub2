...
module AI3
  module Chatbots
    class FourChan
      ...
      def connect(config)
        @boards = config[:boards] || %w[g pol b]
      ...
      def should_respond?(message)
        ...
        return true if (message.platform_data[:board] == 'g') && content.match?(/\b(programming|linux|ai|code)\b/)
      ...
      def fetch_board_threads(_board)
