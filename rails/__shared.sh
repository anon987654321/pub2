...
SHOWEOF
    ...
    sed -i.bak "s/<%%= model_singular %>/${model_singular}/g; s/<%%= model_plural %>/${model_plural}/g" "app/views/${model_plural}/show.html.erb" && rm -f "app/views/${model_plural}/show.html.erb.bak"
}
...
NEWEOF
    ...
    sed -i.bak "s/<%%= model_singular %>/${model_singular}/g; s/<%%= model_plural %>/${model_plural}/g" "app/views/${model_plural}/new.html.erb" && rm -f "app/views/${model_plural}/new.html.erb.bak"
}
...
EDITEOF
    ...
    sed -i.bak "s/<%%= model_singular %>/${model_singular}/g; s/<%%= model_plural %>/${model_plural}/g" "app/views/${model_plural}/edit.html.erb" && rm -f "app/views/${model_plural}/edit.html.erb.bak"
}
